...
public final class ModItemsForge
{
	...
	public static void registerItems(RegisterEvent event)
	{
		event.register(ForgeRegistries.Keys.ITEMS, helper ->
		{
			...
			WREvents.register(helper, "p2p_redstone_transmitter", new BlockItem(ModBlocks.p2pRedstoneTransmitter, new Item.Settings()));
			WREvents.register(helper, "p2p_redstone_receiver", new BlockItem(ModBlocks.p2pRedstoneReceiver, new Item.Settings()));
			...
			ModItems.linker = WREvents.register(helper, "linker", new LinkerItem(new Item.Settings()));
		});
	}
}
